...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(ForfaitedNature.MOD_ID, name), item);
    }
    ...
    public static void registerModItems() {
        ForfaitedNature.LOGGER.info("Registering Mod Items for " + ForfaitedNature.MOD_ID);
