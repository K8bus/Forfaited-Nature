package com.ancientstudio.forfaitednature.block;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block, ItemGroup group) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(ForfaitedNature.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block, ItemGroup group) {
        Item item = Registry.register(Registries.ITEM, new Identifier(ForfaitedNature.MOD_ID, name),
    ...
    public static void registerModBlocks() {
        ForfaitedNature.LOGGER.info("Registering ModBlocks for " + ForfaitedNature.MOD_ID);
    }
}
